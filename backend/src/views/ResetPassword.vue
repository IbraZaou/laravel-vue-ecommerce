...
<template>
    <GuestLayout title="Set a new password" @submit="login">
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="password-repeat" class="block text-sm font-medium leading-6 text-gray-900">Repeat your
                            password</label>
                    </div>
                    <div class="mt-2">
                ...
                <div class="text-sm">
                    <RouterLink :to="{ name: 'login' }" class="font-semibold text-indigo-600 hover:text-indigo-500">Already
